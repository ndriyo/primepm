...
GRANT ALL PRIVILEGES ON DATABASE postgres TO owner_role;
...
-- Note: The custom current_user_id() function has been removed and replaced with auth.uid() in all RLS policies
