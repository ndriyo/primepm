...
- **FR-007**: The system MUST display the authenticated user's display name and avatar in the application shell within **2 seconds** of OAuth callback completion (per SC-004), matching the loading-window expectation for today's email/password sign-in.
